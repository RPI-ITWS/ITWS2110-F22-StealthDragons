...
<html lang="en-US">
  ...
  <body>
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav flex-fill justify-content-between pt-2">
              ...
              <li class="nav-item ps-3">
                <a class="btn btn-primary nav-btn" href="#" role="button"
                  >Sell</a
                >
              </li>
            </ul>
    ...
    <section class="container-xxl">
      <h2 class="sec-head-1 text-center pt-5">Seller Dashboard <button class="btn btn-success float-end" data-bs-toggle="modal" data-bs-target="#listing-modal">Create Listing</button></h2>
        ...
        <div class="col">
          <div class="card my-2">
            <div class="card-body">
              <div class="row">
                <div class="col-3">
                  <img class="img-thumbnail sell-img" src="https://ashleyfurniture.scene7.com/is/image/AshleyFurniture/B600001175_1?$AFHS-PDP-Zoomed$" alt="">
                </div>
                <div class="col">
        ...
        <div class="col">
          <div class="card my-2">
            <div class="card-body">
              <div class="row">
                <div class="col-3">
                  <img class="img-thumbnail sell-img" src="../images/textbook2.jpg" alt="">
                </div>
                <div class="col">
                    ...
                    <div class="row justify-content-center">
                      <div class="col">
                        <form>
                            ...
                            <label for="uploadFiles" class="form-label"
                              >Upload Images</label
                            >
